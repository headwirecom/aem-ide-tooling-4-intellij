...
public class EventLogToolWindowFactory implements ToolWindowFactory, DumbAware {
  ...
  static void createContent(Project project, ToolWindow toolWindow, com.intellij.notification.EventLogConsole console, String title) {
  ...
  private static ActionToolbar createToolbar(Project project, Editor editor, com.intellij.notification.EventLogConsole console) {
    ...
    group.add(new com.intellij.notification.EventLogConsole.ClearLogAction(console));
