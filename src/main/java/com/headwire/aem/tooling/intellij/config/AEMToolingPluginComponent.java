 ...
 */
@State(
    name = AEMToolingPluginConfiguration.COMPONENT_NAME,
    storages = {
        @Storage(id = "other", file = "$PROJECT_FILE$")
    }
)
public class AEMToolingPluginComponent
    implements ProjectComponent, Configurable, PersistentStateComponent<Element>
{
...
//    private GroovyCodeStyle codeStyle = GroovyCodeStyle.LEGACY;
    ...
    private AEMToolingPluginConfiguration configDialog;

    public AEMToolingPluginComponent(final Project project) {
