 ...
 */
package com.headwire.aem.tooling.intellij.console.intelliJ;
...
class EventLogConsole {
  ...
  void doPrintNotification(final Notification notification) {
    ...
    com.intellij.notification.EventLog.LogEntry pair = com.intellij.notification.EventLog.formatForLog(notification, StringUtil.repeatSymbol(' ', date.length()));
    ...
    for (Pair<TextRange, HyperlinkInfo> link : pair.links) {
      ...
      if (link.second instanceof com.intellij.notification.EventLog.ShowBalloon) {
  ...
  public static class ClearLogAction extends DumbAwareAction {
    private com.intellij.notification.EventLogConsole myConsole;

    public ClearLogAction(com.intellij.notification.EventLogConsole console) {
