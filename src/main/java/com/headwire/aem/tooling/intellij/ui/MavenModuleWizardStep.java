...
public class MavenModuleWizardStep extends ModuleWizardStep {
  ...
  public MavenModuleWizardStep(SlingModuleBuilder builder, WizardContext context, boolean includeArtifacts) {
  ...
  private void loadSettings() {
    ...
    if (archGroupId == null || archArtifactId == null || archVersion == null) {
      myBuilder.selectArchetype(null);
    }
    else {
      myBuilder.selectArchetype(new MavenArchetype(archGroupId, archArtifactId, archVersion, null, null));
    }
  }
  ...
  public void updateDataModel() {
    ...
    if (myArchetypes != null) {
      myBuilder.selectArchetype(myArchetypes.getSelectedArchetype());
    }
  }
