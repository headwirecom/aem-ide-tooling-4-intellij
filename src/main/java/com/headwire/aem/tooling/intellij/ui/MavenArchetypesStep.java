...
public class MavenArchetypesStep extends ModuleWizardStep implements Disposable {
  ...
  public MavenArchetypesStep(SlingModuleBuilder builder, @Nullable StepAdapter step) {
    myBuilder = builder;
    myStep = step;
  ...
  public void requestUpdate() {
    ...
    if (selectedArch == null) {
      selectedArch = myBuilder.getArchetypeTemplate().getMavenArchetype();
    }
  ...
  private void archetypeMayBeChanged() {
    ...
    if (((myBuilder.getArchetypeTemplate().getMavenArchetype() == null) != (selectedArchetype == null))) {
      myBuilder.selectArchetype(selectedArchetype);
      skipUpdateUI = true;
      try {
        if (myStep != null) {
